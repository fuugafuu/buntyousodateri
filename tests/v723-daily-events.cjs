...
assert.ok(html.includes("window.MOFUMORI_BUILD='7.2.3'"));
assert.ok(html.includes('daily-events.css?v=7.2.3')&&html.includes('daily-events.js?v=7.2.3'));
assert.ok(sw.includes("mofumori-shell-v7.2.3")&&sw.includes('/daily-events.js?v=7.2.3'));
