...
function boot(){accountCard();renderAuth();progressShell();enhanceCollection();refreshProgress();setInterval(()=>{if(document.hidden)return;refreshProgress();enhanceCollection();renderCollectionSummary()},60000)}
